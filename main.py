        ...
        if results.multi_hand_landmarks:
            ...
            if is_heart:
                ...
                if confirmed_heart and heart_state_manager.can_trigger():
                    ...
                    banner_manager.show("I Love you Sarah! /n May I be /nyour Boyfriend <3", 50, frame_height // 2, HEART_COLOR)
                cv2.putText(
                    frame, "Heart <3", (50, 50),
                ...
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    if confirmed == "Fist" and state_manager.can_trigger():
                        ...
                        if confirmed == "Middle Finger":
                            ...
                            #text
                            banner_manager.show("FUCK WORK /nAND FUCK MY MANAGER /nAND DIRECTOR", 50, frame_height // 2, (220, 160, 201))
